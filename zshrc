...
plugins=(osx git extract brew zsh-syntax-highlighting python django virtualenv bower npm scala sbt go docker vagrant)
...
export ANT_HOME="/Users/dolanotoole/tools/apache-ant-1.9.2"
export TERM=xterm-256color
ORACLE_HOME=/usr/lib/oracle/xe/app/oracle/product/10.2.0/server
PATH=/usr/local/bin:$HOME/bin:$JAVA_HOME/bin:$PATH:$ORACLE_HOME/bin:$JBOSS_HOME/bin:$ANT_HOME/bin
export ORACLE_HOME
...
### Go
export GOPATH=$GOPATH:/Users/dolanotoole/projects/go
export PATH=$PATH:/usr/local/opt/go/libexec/bin

### maven
export MAVEN_HOME="$HOME/tools/apache-maven-3.3.1"
export PATH=$PATH:$MAVEN_HOME/bin
export NODE_ENV=hack
